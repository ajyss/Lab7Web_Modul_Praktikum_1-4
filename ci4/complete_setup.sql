-- COMPLETE DATABASE SETUP FOR LOGIN MODULE
-- Jalankan ini di phpMyAdmin atau CLI

-- 1. Buat database jika belum ada
CREATE DATABASE IF NOT EXISTS lab_ci4;
USE lab_ci4;

-- 2. Hapus tabel lama jika ada (fresh start)
...
-- 5. Insert user data (password: admin123)
